...
from shared import (
    ...
    run_multi_year_validations, run_lifecycle_validations,
    run_descriptor_consistency_check,
    FINANCE_RESOURCES, FINANCE_COLS, FINANCE_SAMPLE_DEFAULTS,
    FINANCE_NESTED, FINANCE_API_ENDPOINT_TEMPLATES,
    FINANCE_BASE_EDFI, FINANCE_BASE_IDOE,
)


def render_verification():
    # Render top ribbon for default page
    render_top_ribbon(
